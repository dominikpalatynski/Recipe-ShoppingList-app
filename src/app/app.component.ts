...
export class AppComponent implements OnInit, OnDestroy {
  ...
  onServiceTest() {
    this.loggingService.logStatusChange('siema');
  }
  ngOnInit() {
    this.accounts = this.loggingService.accounts;
    this.loadFeature = this.loggingService.loadS;
    this.activeToInactive = this.user.activeToInactive;
    this.inactiveToActive = this.user.inactiveToActive;
    this.activatedSub = this.user.activatedButt.subscribe((didAct) => {
      this.actBut = didAct;
    });
  }
  ngOnDestroy() {
  ...
  onDebug() {
    console.log(this.loggingService.loadS);
  }
  onLoadServers() {
